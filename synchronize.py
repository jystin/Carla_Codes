...
def sensor_callback(sensor_data, sensor_queue, sensor_name):
    if 'lidar' in sensor_name:
        sensor_data.save_to_disk(os.path.join('outputs_cline/output_synchronized', '%06d.ply' % sensor_data.frame))
    if 'camera' in sensor_name:
        sensor_data.save_to_disk(os.path.join('outputs_cline/output_synchronized', '%06d.png' % sensor_data.frame))
...
def main():
    ...
    try:
        ...
        output_path = 'outputs_cline/output_synchronized'
