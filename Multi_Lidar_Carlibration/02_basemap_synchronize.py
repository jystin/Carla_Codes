...
def main():
    ...
    try:
        ...
        detected_object_bp = blueprint_library.find('static.prop.mesh')
        detected_object_transform = carla.Transform(carla.Location(x=10, y=204.5, z=1.1), carla.Rotation(0, 0, 0))
        ...
        # transform = carla.Transform(carla.Location(x=0, y=0, z=0), carla.Rotation(pitch=0.000000, yaw=0.000000, roll=0.000000))
